...
class DahuaDataUpdateCoordinator(DataUpdateCoordinator):
    ...
    def __init__(self, hass: HomeAssistant, events: list, address: str, port: int, rtsp_port: int, username: str,
        ...
        self.rpc2: DahuaRpc2Client = DahuaRpc2Client(username, password, address, port, rtsp_port, self._session)
    ...
    async def _async_update_data(self):
        ...
        if not self.initialized:
            try:
                ...
                # try:
                #     await self.rpc2.async_get_snapshot(0)
...
#Checking lighting_v2 support
        ...
        try:
            ...
            #     light_v2 = await self.rpc2.async_get_lighting_v2()
